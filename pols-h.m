...
pols[\[Mu]_,\[Sigma]_,\[Alpha]_,n_,h_]:=NIntegrate[2*x*(1-x)*\[Phi][x,n,s,\[Nu],\[Nu],h]/const[n,s,\[Nu],\[Nu],h]*PDF[TruncatedDistribution[{\[Mu]-5*\[Sigma],\[Mu]+5*\[Sigma]},SkewNormalDistribution[\[Mu],\[Sigma],\[Alpha]]],s],{x,0,1},{s,\[Mu]-5*\[Sigma],\[Mu]+5*\[Sigma]},Method->"DuffyCoordinates"]//Re
