...
pols1=Table[pols[Chop[\[Mu]],\[Sigma],\[Alpha],n1],{\[Alpha],-10,1,0.56},{\[Sigma],10^-8,2.5*10^-4,1.3*10^-5},{\[Mu],-1*10^-4,5*10^-5,0.76*10^-5}];
Export["pols_SkewNormal_50,000-QuasiMonteCarlo-20.csv",pols1]

pols2=Table[pols[Chop[\[Mu]],\[Sigma],\[Alpha],n2],{\[Alpha],-10,1,0.56},{\[Sigma],10^-8,2.5*10^-4,1.3*10^-5},{\[Mu],-1*10^-4,5*10^-5,0.76*10^-5}];
