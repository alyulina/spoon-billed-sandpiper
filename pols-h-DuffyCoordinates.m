...
pols=Table[subs[\[Mu],\[Sigma],\[Alpha],n2,0],{\[Alpha],-10,1,1.2},{\[Sigma],10^-8,2.5*10^-4,2.75*10^-5},{\[Mu],-1*10^-4,5*10^-5,1.65*10^-5}];

Export["pols_SkewNormal_500,000_0-DuffyCoordinates-10.csv",pols]