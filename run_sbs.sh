...
#SBATCH --job-name=sbsv22
#SBATCH --output=/nfs/scistore08/kondrgrp/alyulina/sandpiper/dynamics/h=sigm/ver22/sbs/outs/sbs-%A_%a.out
#
...
srun --cpu_bind=verbose /nfs/scistore08/kondrgrp/alyulina/sandpiper/dynamics/h=sigm/ver22/SBSv8 $(head -$SLURM_ARRAY_TASK_ID SBS_input.txt | tail -1)
