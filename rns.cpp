...
int main (int argc, char** argv)
{
    ...
    long i, gener, popsize, z, y, runs;
    int num_muts, fixed, size, test;
    double *numhetero, *numhomo, *heteroz, *het_pq, rand, lethals, mu, sigma, alpha, beta;
    char* dt;
    
    std::map<int, std::map<int, float> > homo_temp;
